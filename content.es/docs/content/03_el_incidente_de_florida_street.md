...
title: "03 - El Incidente de Florida Street"
image: _din_style/banner_images/03_imb.webp
---

# El Incidente de Florida Street
...
Durante mucho tiempo (2023-2024), una de las explicaciones más repetidas del incidente fue que existía un conflicto entre Sam Altman, interesado en acelerar el desarrollo y comercialización de los productos de OpenAI, e Ilya Sutskever, cada vez más preocupado por la seguridad de sistemas avanzados. 

Esta noticia dio la vuelta al mundo y pilló por sorpresa a toda la comunidad, creando una variedad de opiniones, especulaciones y memes como mi favorito personal: "*What did Ilya see?*" (¿Qué vio Ilya?). Sin embargo, documentos y testimonios posteriores revelarían una historia más compleja.

En una declaración judicial de 2025, Ilya reconoció que llevaba **al menos un año considerando la posibilidad de reemplazar a Sam Altman**. A petición de los directores independientes, terminó preparando un documento de 52 páginas cuyo argumento central afirmaba que: Sam exhibía un patrón consistente de mentir, socavar a sus ejecutivos y enfrentarlos entre sí.[^X]

Una parte importante del material utilizado para construir este caso provenía de Mira Murati. Quien posteriormente bajo juramento (2026) realizo declaraciones similares: describió a Sam como alguien capaz de decir una cosa a una persona y lo contrario a otra, creando caos entre los ejecutivos y dificultando su propio trabajo como CTO.[^Y]

Pero, resumiendo lo que fueron días de caos absoluto: después de una amenaza de renuncia masiva de cientos de empleados de OpenAI y la oferta de Microsoft para armar una organización/laboratorio para Sam junto a todo su séquito dentro del propio Microsoft, no le quedó otra opción a la junta de directivos que **restituir a Sam tan solo cinco días después** de su despido, para luego ver reemplazados a todos sus miembros poco después, salvo Adam D'Angelo.
...
Las consecuencias del incidente de noviembre no tardarían en materializarse. Varios meses después, en mayo de 2024, ocurrió la primera de dos fragmentaciones importantes en OpenAI: la renuncia o, más precisamente, el **despido indirecto de Ilya Sutskever**, cofundador y científico jefe de la compañía. Hablamos de "despido indirecto" porque, según múltiples fuentes, después del intento fallido de remover a Sam Altman, Ilya quedó efectivamente aislado dentro de la empresa, con acceso reducido a recursos e influencia prácticamente nula.

La respuesta de Ilya llegaría en junio de 2024, con la creación de su propia *startup*: Safe Superintelligence Inc., o simplemente SSI. Con un solo objetivo declarado: **construir superinteligencia de manera segura, sin ningún producto intermedio**. SSI representa probablemente uno de los laboratorios más hermético de la industria.
...
La segunda fragmentación importante llegaría poco más de un año después del incidente con Sam Altman. En **febrero de 2025**, Mira Murati, quien había abandonado su puesto como CTO de OpenAI cinco meses antes, decidió iniciar su propia aventura: **Thinking Machines Lab**.
...
Sin embargo, el lanzamiento más relevante de Thinking Machines Lab no fue un *paper* ni un modelo, sino un servicio comercial: **Tinker**. Se trata de una **plataforma accesible vía API** que permite a empresas y desarrolladores hacer *fine-tuning* de LLMs de manera personalizada. Tú controlas el algoritmo y los datos de entrenamiento; ellos ponen toda la infraestructura computacional y la escalabilidad.

Y en el mundo de la IA de 2025, unos cuantos *blog posts* y una API funcional son suficiente para abrir las puertas de la siguiente ronda de financiamiento. La cual estimaba valuaciones en torno a los 50 mil millones de dólares, pero termino estancandose, y convirtiendose en una inversion de NVIDIA por un monto no publicado junto con un acuerdo de proveer 1GW de GPUs.

El desarrollo de modelos propios llegaria despues.
...
**Nota del autor:** 
1. La última pregunta hace referencia a Dario Amodei, cofundador de Anthropic y exvicepresidente de investigación de OpenAI, quien abandonó la compañía a finales del 2020 junto con otros investigadores clave para fundar lo que hoy es uno de los principales competidores de OpenAI. Anthropic, creadora de la familia de modelos Claude, nació precisamente de esas mismas tensiones entre velocidad de desarrollo y consideraciones de seguridad que años después provocarían el incidente de Florida Street. La historia, como suele hacer, tiende a rimar.
