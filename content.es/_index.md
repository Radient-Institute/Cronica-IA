...
# Crónica de la IA Moderna {anchor=false}

Un proyecto colaborativo creado y mantenido por la comunidad de Radient Institute.
...
- {{< card >}}
  ...
  Si detectas errores, tienes información adicional o quieres proponer mejoras, puedes abrir un issue en el repositorio de [GitHub](https://github.com/Radient-Institute/Cronica-IA) del proyecto.
  {{< /card >}}
{{% /columns %}}